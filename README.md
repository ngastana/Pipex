🧩 Pipex
This proyect recreates the behavior of the Unix pipe (|) — that magical little symbol that lets you chain commands together.
In other words, the program takes the output of one command and feeds it as input to another, just like the shell does.

🧠 Project Overview
It’ll be building a program that mimics this:
...
⚙️ Allowed Functions
You’ll mostly be living off the land with:
